...
fontSize: '17px', // Размер шрифта
    ...
    padding: '0',
		...
		backgroundColor: cell.tool === "Ruins" ? '#290000' : cell.tool === "Space" ? '#241800' : cell.content === "contentEmpty" ? '#127852' : cell.tool === "Ruins" ? '#290000' : cell.content === "Iron" ? 'silver' : cell.content === "Coal" ? '#474747' : cell.content === "Update" ? '#035a66' : cell.content === "Null" ? '#035a66' : '#121212',
														display: 'flex',
														justifyContent: 'center',
														alignItems: 'center',
														cursor: 'pointer',
...
<p
    style={{
        ...
        alignItems: 'flex-start',
        margin: '0',
        color: isGamePaused === 1 ? '#bcbf00' : dynamicEarlyValue > 60 ? 'red' : '#bcbf00',
        fontWeight: 'bold',
        fontSize: '17px',
        textAlign: 'center',
        marginTop: '1px',
