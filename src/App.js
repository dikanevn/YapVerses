        ...
        >
            ...
            <div style={{ fontSize: "14px", color: "#ccc" }}>
                ...
                <ul style={{ padding: 0, margin: 0, listStyleType: "none" }}>
                    ...
                    <li>⦁ Найдите астероид - нажмите кнопку 🔭 и дождитесь загрузки зелёных клеточек - это трава типа.</li><br />
...
Пока развёрнуто в Manta Pacific Sepolia Testnet но прогресс будет мигрирован в основные сети. 
					</li>
